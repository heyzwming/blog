---
title: 吴恩达机器学习课程笔记（一）：Introduction
date: 2019-03-24
...
![1.3.1](/assets/machinelearning/img/1.3.1.jpg)
...
![1.3.2](/assets/machinelearning/img/1.3.2.jpg)
...
![1.3.3](/assets/machinelearning/img/1.3.3.jpg)
...
![1.3.4](/assets/machinelearning/img/1.3.4.jpg)
...
![1.4.1](/assets/machinelearning/img/1.4.1.jpg)
...
![1.4.2](/assets/machinelearning/img/1.4.2.jpg)


例3.2 我们进入谷歌新闻，可以看到BP油井事故的专题，有华尔街日报、CNN、卫报。在这个例子中，谷歌通过搜索成千上万条新闻，再自动将数据集聚类，把相关内容显示到一起。

![1.4.3](/assets/machinelearning/img/1.4.3.jpg)
